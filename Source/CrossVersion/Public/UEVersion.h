...
#define UE_GET_RELATIVE_MODULE_PATH_T_OBJECT_PTR_FUNCTION_PARAMETERS UE_VERSION_START(5, 3, 0)
...
#define UE_USER_DEFINED_STRUCTURE UE_VERSION_START(5, 5, 0)

#define UE_F_CONTENT_BROWSER_ITEM_DATA_INTERNAL_PATH UE_VERSION_START(5, 5, 0)
